...
class Storage:
    ...
    def __init__(self, api_key, storage_zone, show_slug, storage_zone_region="uk"):
        """
        ...
        if storage_zone_region == "de" or storage_zone_region == "":
            self.base_url = "https://storage.bunnycdn.com/" + storage_zone + "/" + show_slug + "/"
        else:
            self.base_url = (
                "https://"
                + storage_zone_region
